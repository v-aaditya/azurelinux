...
# AZL3: Rename FIPS provider.
Patch45:  0045-FIPS-services-minimize-3.2.4-AZL3.patch
...
# AZL3: Removed usage of sdt APIs
...
./Configure \
    ...
    no-zlib-dynamic \
    enable-buildtest-c++ \
    $RPM_OPT_FLAGS '-DDEVRANDOM="\"/dev/urandom\"" -DREDHAT_FIPS_VERSION="\"%{fips}\""' -D_GNU_SOURCE \
    -Wl,--allow-multiple-definition
